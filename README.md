...
## Bigger Concept: WBS-driven Agent Control (WdAC)

Agent Work Snapshot is not meant to be just another standalone JSON Schema.
It comes from a broader idea: **WBS-driven Agent Control (WdAC)**, where a WBS
or canonical task model remains the source of truth while AI agents, human
